...
public class Deck {
    ...
    public void printDeck() {
        ...
        for (Card card : deck) {
            if (card.getCardOrientation()) {
                // System.out.println(card.getCardName() + " / " + "Upright" + " / " +
                // card.getCardUprightDescription());
            } else {
                // System.out.println(card.getCardName() + " / " + "Reverse" + " / " +
                // card.getCardReversedDescription());
            }
        }
    }
    ...
    public void numberDraw(int index) {
        ...
        if (drawnCard.getCardOrientation()) {
            // System.out.println(drawnCard.getCardName() + " / " + "Upright" + " / " +
            // drawnCard.getCardUprightDescription());
        } else {
            // System.out.println(drawnCard.getCardName() + " / " + "Reverse" + " / " +
            // drawnCard.getCardReversedDescription());
        }
    }
